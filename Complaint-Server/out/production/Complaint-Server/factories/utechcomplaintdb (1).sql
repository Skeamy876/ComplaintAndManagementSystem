...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 09, 2023 at 10:31 PM
...
CREATE TABLE `students` (
  ...
  `email_address` varchar(25) NOT NULL,
  `phone_number` int(10) NOT NULL,
  `query_ID` int(20) DEFAULT NULL COMMENT 'foreign key',
...
INSERT INTO `students` (`student_ID`, `first_name`, `last_name`, `email_address`, `phone_number`, `query_ID`, `complaint_ID`) VALUES
(1001, 'Jack', 'Daniels', 'jackedaniels@hotmail.com', 9875643, NULL, NULL);
...
CREATE TABLE `supervisor` (
  ...
  `phone_number` int(10) NOT NULL,
  `query_ID` int(20) DEFAULT NULL COMMENT 'foreign key',
  `student_ID` int(20) DEFAULT NULL COMMENT 'foreign key',
  `advisor_ID` int(20) DEFAULT NULL COMMENT 'foreign key'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
