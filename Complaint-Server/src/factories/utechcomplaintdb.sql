...
INSERT INTO `query` (`queryId`, `query_date`, `query_detail`, `status`, `category_ID`, `student_idNumber`) VALUES
...
INSERT INTO `students` (`idNumber`, `email_address`, `first_name`, `last_name`, `phone_number`) VALUES
